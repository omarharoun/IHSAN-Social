...
export function useAgeAssuranceCopy() {
  ...
  return useMemo(() => {
    return {
      notice: _(
        msg`The laws in your location require you to verify you're an adult before accessing certain features on IHSAN, like adult content and direct messaging.`,
      ),
      banner: _(
