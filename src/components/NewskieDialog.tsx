  ...
  const getJoinMessage = () => {
    ...
    if (isMe) {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`You joined IHSAN using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`You joined IHSAN ${timeAgoString} ago`)
      }
    } else {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`${profileName} joined IHSAN using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`${profileName} joined IHSAN ${timeAgoString} ago`)
      }
    }
  }
